...
import { X, Users, TrendingUp, DollarSign, ArrowDownCircle, BarChart2 } from 'lucide-react';
            ...
            <div className="space-y-8">
              ...
              {activeTab === 'telegram' && (
                <div className="space-y-6">
                  <h3 className="text-lg font-bold">Telegram Automation & Analytics</h3>
                  <div className={`p-4 rounded-xl border ${theme === 'dark' ? 'border-slate-800 bg-slate-900/50' : 'border-gray-200 bg-white'}`}>
                    <h4 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4">Telegram Group Member Growth</h4>
                    <div className="h-64">
                      <ResponsiveContainer width="100%" height="100%">
