        ...
        {botTab === 'telegram' && isAdmin && (
          <div className="flex flex-col flex-1 select-none">
            ...
            <div className="flex border-b border-gray-150 dark:border-zinc-850 bg-slate-100 dark:bg-zinc-900/60 font-semibold text-[10px] tracking-tight text-slate-500 select-none">
              ...
              {currentUser?.email === 'peterchristine820@gmail.com' && (
                <button
            ...
            <div className="flex-1 p-3.5 space-y-3 flex flex-col justify-between overflow-y-auto">
                        ...
                        {tgLogs.slice(-25).map((log) => {
                          ...
                          return (
                            <div key={log.id} className={`p-2 rounded-lg text-left max-w-[90%] ${
                              ...
                              <p className="font-sans whitespace-pre-line tracking-tight leading-normal text-[10px]">
                                {log.text}
                              </p>
              ...
              {tgSubTab === 'api_settings' && currentUser?.email === 'peterchristine820@gmail.com' && (
                <div className="space-y-3.5 text-left text-xs">
                  ...
                  >
                    ...
                    <span>{isSavingConfig ? 'saving settings...' : 'Save Token & Activate Webhook'}</span>
                  </button>
              ...
              {tgSubTab === 'members' && (
                <div className="space-y-3 flex flex-col flex-1 pb-1">
                  ...
                  <div className="flex-1 overflow-y-auto space-y-2 max-h-[220px]">
                    {tgUsers.map((user) => (
                      <div key={user.id} className="flex items-center justify-between text-[11px] p-2 bg-slate-50 dark:bg-zinc-900/60 rounded border border-gray-150 dark:border-zinc-800/80">
                        <span className="font-mono text-indigo-600 dark:text-indigo-400 text-left font-bold">{user.username}</span>
                  ...
                  <button
                    ...
                    className="w-full mt-2 bg-slate-900 hover:bg-slate-950 text-white font-bold p-2 rounded text-[10px] uppercase flex items-center justify-center space-x-1 cursor-pointer select-none"
                  >
                    <UserPlus className="w-3.5 h-3.5" />
                    <span>Invite & Add Simulated User</span>
                  </button>
                </div>
              )}
